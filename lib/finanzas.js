...
const CFG = {
  ...
  // Pestañas de CONSULTA: los consolidados. Cada celda es una fórmula que
  // apunta a la hoja del año, así que aquí se lee pero nunca se escribe.
  PESTANAS: {
    ingresos: E.TAB_INGRESOS || 'INGRESOS',
    egresos:  E.TAB_EGRESOS  || 'EGRESOS'
  },

  // Pestañas de CAPTURA: ahí sí vive el dato. El consolidado las refleja.
  // Se arma con el año, porque hay una hoja por año: "INGRESOS 2026".
  PESTANA_ALTA: {
    ingresos: E.TAB_ALTA_INGRESOS || 'INGRESOS',
    egresos:  E.TAB_ALTA_EGRESOS  || 'EGRESOS'
  },
...
// A qué pestaña se escribe un movimiento de cierto año.
// Si "INGRESOS 2026" no existe, se avisa en vez de escribir en el consolidado:
// hacerlo borraría fórmulas y desligaría el renglón de la hoja de su año.
function pestanaDeAlta(clave, anio) {
  return (CFG.PESTANA_ALTA[clave] || CFG.PESTANAS[clave]) + ' ' + anio;
}

module.exports = { CFG, leer, columna, mapaDeColumnas, esFlujo, esOperacion, pestanaDeAlta,
