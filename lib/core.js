...
const MENU = [
  ...
  { key:'inversiones_g', label:'Inversiones',    icon:'card', children:[
      { key:'inv_analisis',      label:'Análisis de inversiones' },
  ...
  { key:'finanzas',    label:'Finanzas',         icon:'dollar', children:[
      // "Ingresos y Egresos" lee las pestañas INGRESOS y EGRESOS del archivo
      // Dashboard Ingresos-Egresos. Los ítems sueltos de Ingresos y Egresos que
      // había aquí se quitaron: eran del menú de arranque, no apuntaban a
      // ninguna hoja y confundían con el área que sí funciona.
      { key:'fin_flujo', label:'Resumen del flujo' },
...
// Archivo Dashboard Ingresos-Egresos.
const FINANZAS_ID = process.env.SHEET_FINANZAS || '1YMP_ZtPlU2C8MVuNCgq2dO_kOXX2BPCC3XUazww89tM';
...
const SHEETS = {
  ...
  // Listado completo de movimientos. Las pestañas INGRESOS y EGRESOS del archivo
  // de finanzas son CONSOLIDADOS: cada celda es una fórmula que apunta a
  // "INGRESOS 2025" / "INGRESOS 2026". Por eso estas áreas son de solo lectura
  // (ver AREAS_SOLO_LECTURA): escribir aquí borraría las fórmulas y rompería la
  // liga con la hoja del año. Las altas van a la hoja del año, no aquí.
  ingresos:           { id: FINANZAS_ID, sheetName: 'INGRESOS' },
  egresos:            { id: FINANZAS_ID, sheetName: 'EGRESOS' },
...
// Áreas que solo se consultan. El servidor rechaza cualquier alta o edición
// aquí, no solo la interfaz: una hoja de fórmulas se arruina con un solo guardado.
const AREAS_SOLO_LECTURA = ['ingresos', 'egresos', 'cxc'];
...
const FORMULA_FIELDS = {
  ...
  // En INGRESOS y EGRESOS no hay una sola columna capturada a mano: todas
  // son fórmulas que traen el dato de la hoja del año.
  ingresos: ['Fecha','Mes','Año','Concepto','Descripción','Línea de negocio','Total',
             'Método de cobro','Cuenta','Cliente','Concepto Estado de cuenta','Factura',
             'Concepto CFDI','UUID','Categoría','Subcategoría','Comentarios'],
  egresos:  ['Fecha','Mes','Año','Concepto','Descripción','Línea de negocio','Total',
             'Método de pago','Cuenta','Cliente','Proveedor','Concepto Estado de cuenta',
             'Factura','UUID','Concepto CFDI','Categoría','Subcategoría','Comentarios']
  // proy_horas:      ['Importe'],
};
...
module.exports = { VERSION, MENU, SHEETS, FINANZAS_ID, AREAS_SOLO_LECTURA, USERS_SHEET, FORMULA_FIELDS, AREA_ROW_FILTERS,
