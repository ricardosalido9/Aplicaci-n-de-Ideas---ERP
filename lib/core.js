...
const MENU = [
  ...
  { key:'comercial',   label:'Comercial',        icon:'tag', children:[
...
const SHEETS = {
  // ---- Conectadas ----
  // (todavía ninguna: pega abajo los IDs de las hojas de Aplicación de Ideas)
  ...
  // ventas_registro:  { id: 'PEGA_EL_ID', sheetName: 'VENTAS' },
  ...
  // Cuentas por Cobrar lee la MISMA hoja de VENTAS y muestra solo las filas con saldo.
  // Descomenta cuando la hoja de ventas tenga una columna llamada "Por Cobrar":
  // cxc:              { id: 'EL_MISMO_ID_DE_VENTAS', sheetName: 'VENTAS' },
};
...
const AREA_ROW_FILTERS = {
  // Cuentas por Cobrar lee la hoja de Ventas y muestra solo lo que sigue pendiente
  cxc: { field: 'Por Cobrar', op: 'gt0' }
};
...
// Pega el ID aquí o cárgalo como variable de entorno USERS_SHEET_ID en Vercel.
const USERS_SHEET = {
  id: process.env.USERS_SHEET_ID || 'PEGA_EL_ID_DE_LA_HOJA_DE_USUARIOS',
...
const FORMULA_FIELDS = {
  ...
  // proy_horas:         ['Importe'],
  // rrhh_colaboradores: ['Edad', 'Antigüedad', 'Área', 'Departamento']
};
